...
public class TestBase {
	...
	public int statuscode_200=200;
	public int statuscode_500=500;
	public int statuscode_204=204;
	...
	public TestBase()
	{
		try {
		prop = new Properties();
		FileInputStream ip = new FileInputStream(System.getProperty("user.dir")+"/src/main/java/com/qa/configuration/config.property");
